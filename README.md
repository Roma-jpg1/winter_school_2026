# Зимняя школа по алгоритмам (YADRO&СибГУТИ - трек "Алгоритмы в высоконагруженных системах")

# High-Load Storage

Этот репозиторий — заготовка для 3-дневного интенсива по алгоритмам. Для закрепления теории мы не просто будем разрабатывать базу данных, мы построим ключевые компоненты **оператора мобильной связи** (естественно в упрощенном варианте):
...
### День 1: HLR и In-Memory хранилище
...
### День 3: Fraud Detection и оптимизация решения
